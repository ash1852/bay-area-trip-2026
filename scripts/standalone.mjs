...
const [html,css,leafletCss,leafletJs,data,hierarchy,app]=await Promise.all(['index.html','styles.css','vendor/leaflet.css','vendor/leaflet.js','data/itinerary.js','data/hierarchy.js','app.js'].map(read));
